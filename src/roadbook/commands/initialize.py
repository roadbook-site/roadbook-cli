...
def init_book(args):
    ...
    try:
        ...
        if requires_login:
            ...
            console.print("The roadbook is marked as requiring login.")
            console.print("Authentication logic has been scaffolded into your script.py.")
            console.print("Please handle the login flow during script execution using `rb.auth`.")
